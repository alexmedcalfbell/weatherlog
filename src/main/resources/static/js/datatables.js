 ...
 *   https://datatables.net/download/#bs4/dt-1.10.18/b-1.5.4/b-html5-1.5.4/kt-2.5.0
 *
 * Included libraries:
 *   DataTables 1.10.18, Buttons 1.5.4, HTML5 export 1.5.4, KeyTable 2.5.0
 */
...
(function (h) {
    ...
    n.ext = x = {
        buttons: {},
        classes: {},
        build: "bs4/dt-1.10.18/b-1.5.4/b-html5-1.5.4/kt-2.5.0",
        errMode: "alert",
        feature: [],
        search: [],
...
$jscomp.polyfill = function (b, g, e, n) {
    if (g) {
        ...
        n = e[b];
        g = g(n);
        g != n && null != g && $jscomp.defineProperty(e, b, {configurable: !0, writable: !0, value: g})
    }
};
...
(function (b) {
    ...
    var l = b.fn.dataTable, p = function (a, c) {
    ...
    b.extend(p.prototype, {
        blur: function () {
            ...
            this._tabInput();
            var a = this, c = this.s.dt, d = b(c.table().node());
            ...
            c.on("draw.keyTable", function (d) {
                if (!a.s.focusDraw) {
                    ...
                    if (f && f.node && b(f.node).closest("body") === e.body) {
                        ...
                        var k = c.page.info(), m = f.row + k.start;
            ...
            var a = this.s.dt, c = this;
            g.getSelection && (b(e).on("copy.keyTable", function (a) {
                a = a.originalEvent;
                var b = g.getSelection().toString(), d = c.s.lastFocus;
                ...
                b = b.originalEvent;
                var d = c.s.lastFocus, f = e.activeElement, m = c.c.editor, h;
                !d || f && "body" !==
            ...
            var k = this, f = this.s.dt,
                m = this.c.editor, h = this.s.lastFocus.cell;
            ...
            var f = this, m = this.s.dt, h = m.page.info(),
                q = this.s.lastFocus;
            k || (k = null);
            if (this.s.enable) {
                if ("number" !== typeof a) {
                    ...
                    var l = a.index();
                    c = l.column;
                    a = m.rows({filter: "applied", order: "applied"}).indexes().indexOf(l.row);
                    if (0 > a) return;
                ...
                if (-1 !== h.length && (a < h.start || a >= h.start + h.length)) this.s.focusDraw = !0, this.s.waitingForDraw = !0, m.one("draw", function () {
                    ...
                    h.serverSide &&
                    (a -= h.start);
                    h = m.cells(null, c, {search: "applied", order: "applied"}).flatten();
                    h = m.cell(h[a]);
                    if (q) {
                        if (q.node === h.node()) {
                    ...
                    this.s.lastFocus = {
                        cell: h, node: h.node(), relative: {
                            row: m.rows({page: "current"}).indexes().indexOf(h.index().row),
            ...
            if (this.s.waitingForDraw) a.preventDefault(); else {
                ...
                if (c && (!(0 === a.keyCode || a.ctrlKey || a.metaKey || a.altKey) || a.ctrlKey && a.altKey) && this.s.lastFocus) {
                    var k = this.s.dt, f = this.s.dt.settings()[0].oScroll.sY ? !0 : !1;
                    if (!this.c.keys || -1 !== b.inArray(a.keyCode, this.c.keys)) switch (a.keyCode) {
                        ...
                        case 35:
                        case 36:
                            d && (a.preventDefault(), c = k.cells({page: "current"}).indexes(), d = this._columns(), this._focus(k.cell(c[35 === a.keyCode ? c.length - 1 : d[0]]), null, !0, a));
                            break;
                        case 37:
            ...
            var c = d[k](), m = d.outerHeight(), h = d.outerWidth(), g = b.scrollTop(), e = b.scrollLeft(),
                l = a.height();
            a = a.width();
            ...
            var k = this.s.dt, f = k.page.info(), g = f.recordsDisplay, h = this.s.lastFocus.cell, e = this._columns();
            if (h) {
                var l = k.rows({
                    filter: "applied",
                    order: "applied"
            ...
            var a = this, c = this.s.dt, d = null !== this.c.tabIndex ? this.c.tabIndex : c.settings()[0].iTabIndex;
            if (-1 !=
                ...
                c.cell(":eq(0)", {page: "current"}).any() && a._focus(c.cell(":eq(0)", "0:visible", {page: "current"}), null, !0, b)
            })
        }, _updateFixedColumns: function (a) {
            var b = this.s.dt, d = b.settings()[0];
            if (d._oFixedColumns) {
